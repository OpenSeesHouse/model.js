...
#        as part of the OpenSees course in Faradars institute           #
...
logCommands -file test2d_Commands.tcl 		;#We cannot have AutoCAD understand TCL commands while importing our model
