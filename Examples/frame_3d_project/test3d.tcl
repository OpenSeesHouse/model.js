...
logCommands -file test3d_Commands.tcl 		;#We cannot have AutoCAD understand TCL commands while importing our model
...
algorithm Newton
set numSteps 100
integrator DisplacementControl [expr $nflrs*100+1*10+1] 1 [expr 0.25*$nflrs*$H/$numSteps]
